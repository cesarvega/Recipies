...
-(void)populateProductsTable{
    NSString * userdefaultexist = [[NSUserDefaults standardUserDefaults] objectForKey:@"myUserDefaultsKey"];
    if (![@"NO" isEqual:userdefaultexist]){
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Recipies" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Recipies.sqlite"];
